...
Public Class MedicalDirector_sAccess

    Private Sub MedicalDirector_sAccess_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TextBox1.Focus()
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            Else
                ...
                Next
                Me.Hide()
                MedicalDirector.lblUser.Text = TextBox1.Text
                MedicalDirector.Show()
            End If
            myCommand.Dispose()
            myConnection.Close()
