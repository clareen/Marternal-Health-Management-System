...
Public Class Adminal
    ...
    Private Sub Adminal_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Public Function make() As Object
        ...
        e = "1234567890abcdefghijklmnopqrstuvwxyzFGRSTUVWXYZ"
        f = Len(e)
        g = 7
        Randomize()
        h = ""
    ...
    Private Sub Button3_Click(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            ...
            Dim SelectCommand As MySqlCommand = New MySqlCommand("insert into  `administrator`(`admin_id`, `names`, `username`, `password`)   VALUES ('" & TextBox1.Text & "', '" & TextBox2.Text & "','" & TextBox3.Text & "','" & ListBox1.Text & "') ", mycon)
            Dim SelectCommand1 As MySqlCommand = New MySqlCommand("insert into  `user`(`admin_id`, `names`, `username`, `password`)   VALUES ('" & TextBox1.Text & "', '" & TextBox2.Text & "','" & TextBox3.Text & "','" & ListBox1.Text & "') ", mycon)
        ...
        Try
            ...
            Dim mycon As MySqlConnection = New MySqlConnection(myConnection)
            'Dim SelectCommand As MySqlCommand = New MySqlCommand("insert into  `administrator`(`admin_id`, `names`, `username`, `password`)   VALUES ('" & TextBox1.Text & "', '" & TextBox2.Text & "','" & TextBox3.Text & "','" & ListBox1.Text & "') ", mycon)
            Dim SelectCommand1 As MySqlCommand = New MySqlCommand("insert into  `user`(`userid`, `names`, `username`, `password`)   VALUES ('" & TextBox1.Text & "', '" & TextBox2.Text & "','" & TextBox3.Text & "','" & ListBox1.Text & "') ", mycon)
            Dim myReader As MySqlDataReader
            mycon.Open()
            'myReader = SelectCommand.ExecuteReader()
            myReader = SelectCommand1.ExecuteReader()
