...
Public Class Sister
    ...
    Private Sub Button3_Click_1(sender As Object, e As EventArgs) Handles Button3.Click
        Try
            ...
            Dim mycon As MySqlConnection = New MySqlConnection(myConnection)
            Dim SelectCommand As MySqlCommand = New MySqlCommand("insert into  `user`(`userid`, `names`, `username`, `password`)   VALUES ('" & TextBox1.Text & "', '" & TextBox2.Text & "','" & TextBox3.Text & "','" & TextBox4.Text & "') ", mycon)
    ...
    Private Sub Sister_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Button3.Enabled = False
        fillCity()
    End Sub

    Private Sub TextBox4_TextChanged(sender As Object, e As EventArgs) Handles TextBox4.TextChanged
        ListBox1.Text = TextBox4.Text()
